...
## O que mudou na versão 2024.02.0 {#what-changed-in-February-2024}
...
## O que mudou na versão 2023.10.0 {#what-changed-in-October-2023}
...
## O que mudou na versão 2023.08.0 {#what-changed-in-August-2023}
...
## O que mudou na versão 2023.05.0 {#what-changed-in-May-2023}
...
## O que mudou na versão 2023.02.0 {#what-changed-in-February-2023}
...
## O que mudou na versão 2022.10.0 {#what-changed-in-October-2022}
...
## O que mudou na versão 2022.08.0 {#what-changed-in-August-2022}
...
## O que mudou na versão 2022.02.0 {#what-changed-in-Feb-2022}
...
## O que mudou na versão 2021.10.0 {#what-changed-in-october-2021}
...
## O que mudou na versão 2021.08.0 {#what-changed-in-august-2021}

O Brand Portal 2021.08.0 é uma versão interna que apresenta perfis de negócio para clientes corporativos e de equipes para dar às organizações melhor controle sobre seus ativos. Os usuários agora têm direitos específicos da organização nas organizações novas e migradas. Durante a migração, todas as contas existentes da Adobe ID são migradas para IDs de negócio.

* IDs de negócios para todas as organizações novas e já existentes após a migração.
* As IDs de negócio não exigem nenhuma configuração específica, como solicitar um domínio ou configurar um SSO.
* Você pode adicionar usuários com qualquer endereço de email, incluindo domínios de email públicos, como gmail.com ou outlook.com.

**Impacto nos usuários do Brand Portal**

A migração não afeta seu conjunto de dados, ativos, usuários ou quaisquer configurações já existentes. A única mudança interna que ocorre durante a migração é o direito da sua organização já existente aos perfis empresariais.

>[!NOTE]
>
>Os perfis de negócio são atualmente aplicáveis às novas organizações criadas após 16 de agosto de 2021.
>
>Até que sua organização seja migrada, você pode continuar usando Adobe ID, Enterprise ID ou Federated ID para acessar a organização.

### Artigos de referência {#reference-articles}

* [Introdução aos perfis do Adobe](https://helpx.adobe.com/br/enterprise/kb/introducing-adobe-profiles.html)

* [Gerenciar perfis do Adobe](https://helpx.adobe.com/br/enterprise/using/manage-adobe-profiles.html)

* [Atualização da experiência de Logon para usuários e administradores](https://helpx.adobe.com/br/enterprise/using/storage-for-business.html#new-admin-sign-in-exp)

* [Restrição de logon durante a migração](https://helpx.adobe.com/br/enterprise/kb/account-temporarily-unavailable.html)

* [Gerenciar usuários no Admin Console](https://helpx.adobe.com/br/enterprise/using/manage-users-individually.html)

* [Gerenciar perfis de produto para usuários corporativos](https://helpx.adobe.com/br/enterprise/using/manage-product-profiles.html#assign-users)

* [Confiança de domínio](https://helpx.adobe.com/br/enterprise/admin-guide.html/enterprise/using/set-up-identity.html#directory-trusting)
...
## O que mudou na versão 2021.06.0 {#what-changed-in-june-2021}
...
## O que mudou na versão 2021.02.0 {#what-changed-in-feb-2021}
...
Anteriormente, todas as representações de ativos eram baixadas diretamente em uma pasta zip. A caixa de diálogo **[!UICONTROL Download]** era ignorada para pastas e coleções. E não havia nenhum método para controlar o comportamento de download dos ativos, dificultando a pesquisa de uma representação específica no meio de muitos downloads.
...
Faça logon no seu locatário do Brand Portal como administrador e navegue até **[!UICONTROL Ferramentas]** > **[!UICONTROL Download]**. Os administradores podem habilitar a configuração **[!UICONTROL Download de ativos]** para criar uma pasta separada para cada ativo ao baixar pastas, coleções e fazer o download de ativos em massa.

![](assets/download-settings-new.png)

Consulte [baixar ativos do Brand Portal](https://experienceleague.adobe.com/pt-br/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets).
<!--
...
* Exibir todas as representações disponíveis de qualquer ativo na lista de downloads.
* Excluir as representações dos ativos que não são necessárias para o download.
* Aplicar o mesmo conjunto de representações a todos os tipos de ativos semelhantes com um só clique.
* Aplicar um conjunto diferente de representações para tipos de ativos diferentes.
* Criar uma pasta separada para cada ativo.
* Baixar ativos selecionados e suas representações.

O fluxo de trabalho de download é consistente para ativos independentes, vários ativos, pastas com ativos, ativos licenciados ou não licenciados e ao baixar ativos por meio de um link compartilhado. Consulte [etapas para baixar ativos do Brand Portal](https://experienceleague.adobe.com/pt-br/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets).

![download-dialog-box](assets/download-dialog-box.png)

### Navegação rápida {#quick-navigation}

Anteriormente, a opção de exibir **[!UICONTROL Arquivos]**, **[!UICONTROL Coleções]** e **[!UICONTROL Links compartilhados]** estava oculta e exigia vários cliques toda vez que o usuário quisesse mudar para outra exibição.
...
### Configurar definições de download {#download-permissions}

Os administradores do Brand Portal agora podem definir configurações para grupos de usuários para exibir ou baixar ativos e representações originais, ou ambos, na página de detalhes do ativo, além das configurações existentes de **[!UICONTROL Download]**.
...
* Se apenas a configuração **[!UICONTROL Baixar representações]** estiver ativada, os usuários poderão exibir o ativo original, mas não poderão baixá-lo. No entanto, o usuário pode exibir e baixar as representações do ativo.

Consulte [configurar o download de ativos](https://experienceleague.adobe.com/pt-br/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets#configure-download-permissions).

![view-download-permission](assets/download-permissions.png)

>[!NOTE]
>
>Se um usuário for adicionado a vários grupos e se um desses grupos tiver restrições, as restrições se aplicarão ao usuário.
...
O Visualizador de documentos melhora a experiência de exibição de PDF. Ele fornece uma experiência semelhante à da Adobe Document Cloud ao exibir os arquivos em PDF no Brand Portal.

Anteriormente, opções limitadas estavam disponíveis para exibir arquivos em PDF.
...
O processo de download de ativos foi renovado, proporcionando uma experiência do usuário simplificada ao [baixar ativos do Brand Portal](brand-portal-download-assets.md).

O fluxo de trabalho existente de download de ativos do Brand Portal é inevitavelmente seguido pela exibição de uma caixa de diálogo **[!UICONTROL Download]** com várias opções de download.

No Brand Portal 6.4.7, os administradores podem definir as configurações de **[!UICONTROL Download]** de ativos. As configurações disponíveis são:
...
No Brand Portal 6.4.6, o canal de autorização entre o AEM Assets e o Brand Portal foi alterado. O Brand Portal agora é compatível com o AEM Assets as a Cloud Service, AEM Assets 6.3 e superior. No AEM Assets 6.3 e posterior, o Brand Portal foi configurado inicialmente na interface clássica usando o gateway OAuth legado. Esse gateway emprega a troca de tokens JWT para obter um token de acesso IMS para autorização. O AEM Assets agora é configurado com o Brand Portal por meio do Adobe Developer Console, que obtém um token IMS para autorização do seu locatário do Brand Portal.
...
|---|---|---|
| **AEM Assets as a Cloud Service** | [Criar configuração](https://experienceleague.adobe.com/pt-br/docs/experience-manager-cloud-service/content/assets/brand-portal/configure-aem-assets-with-brand-portal) | - |
...
>[!NOTE]
>
>A Adobe recomenda atualizar a instância do AEM para usar o pacote de serviços mais recente.
...
O Brand Portal 6.4.5 permite que agências e equipes externas façam upload de conteúdo no Brand Portal e publiquem no AEM Assets, tudo sem precisar acessar o ambiente do autor. Esse recurso é chamado de **[Origem de ativos no Brand Portal](brand-portal-asset-sourcing.md)** e melhora as experiências do cliente ao fornecer um mecanismo bidirecional para que os usuários contribuam e compartilhem ativos com outros usuários do Brand Portal distribuídos globalmente.

### Origem de ativos no Brand Portal {#asset-sourcing-in-bp}

A Origem de ativos permite que os usuários do AEM (administradores/usuários não administradores) criem pastas com uma propriedade extra **Contribuição de ativos**, garantindo que a nova pasta seja criada e aberta para o envio de ativos por usuários do Brand Portal. Ela aciona automaticamente um fluxo de trabalho que cria duas subpastas adicionais, chamadas NOVO e COMPARTILHADO, na pasta **Contribuição** recém-criada.

O usuário do AEM faz upload de um resumo e ativos de linha de base para a pasta **COMPARTILHADO**. Eles definem os tipos de ativos necessários na pasta de contribuição, garantindo que os usuários do Brand Portal tenham as informações de referência necessárias. O administrador pode conceder aos usuários ativos do Brand Portal acesso à pasta de contribuição antes de publicar a pasta recém-criada **Contribuição** no Brand Portal.


Quando o usuário terminar de adicionar conteúdo à pasta **NOVO**, poderá publicar a pasta de contribuição de volta no ambiente de criação do AEM. Pode levar alguns minutos para concluir a importação e refletir o conteúdo recém-publicado no AEM Assets.

Além disso, todas as funcionalidades já existentes permanecem inalteradas. Os usuários do Brand Portal podem exibir, pesquisar e baixar ativos da pasta contribuição e de outras pastas permitidas. Além disso, os administradores podem compartilhar a pasta de contribuição, modificar propriedades e adicionar ativos a coleções.

>[!NOTE]
>
>A Origem de ativos no Brand Portal é compatível com o AEM 6.5.2.0 e posterior.
>
...
Os usuários do Brand Portal só podem fazer upload de ativos para a subpasta **NOVO**. A pasta **COMPARTILHADO** destina-se à distribuição de requisitos e ativos de linha de base.
...
### Pesquisar aprimoramentos

O Brand Portal 6.4.4 em diante oferece suporte à pesquisa de texto parcial no Predicado de propriedade no painel de filtragem. Para permitir a pesquisa de texto parcial, habilite a opção **Pesquisa parcial** em Predicado de Propriedade no formulário de pesquisa.
...
Se não tiver certeza das palavras exatas que ocorrem na frase pesquisada, poderá usar uma pesquisa com curinga para preencher as lacunas na consulta de pesquisa.
...
Da mesma forma, especificar:

* **&#42;climb** retorna todos os ativos que têm palavras que terminam com os caracteres **climb** na frase de título.

* **&#42;climb&#42;** retorna todos os ativos que contêm palavras que possuem os caracteres **climb** na frase de título.

>[!NOTE]
>
>Ao marcar a caixa de seleção **Pesquisa parcial**, **Não diferenciar maiúsculas e minúsculas** é selecionado por padrão.
...
O Brand Portal 6.4.3 apresenta um alias alternativo para URLs de acesso, uma nova hierarquia de pastas e melhorias no suporte a vídeos. Também apresenta a publicação agendada do autor do AEM para o Brand Portal, melhorias operacionais e atende às solicitações do cliente.

### Navegação na hierarquia de pastas para não administradores

Agora, os administradores podem configurar como as pastas são exibidas para usuários não administradores (Editores, Visualizadores e Usuários convidados) no logon. [A configuração Habilitar Hierarquia de Pasta](../using/brand-portal-general-configuration.md) foi adicionada em **Configurações Gerais**, no painel de ferramentas administrativas. Se a configuração estiver:

* **habilitada**, a árvore de pastas que começa na pasta raiz estará visível para usuários não administradores. Sendo assim, concede a eles uma experiência de navegação semelhante aos administradores.
* **desabilitada**, somente as pastas compartilhadas são exibidas na página de destino.

![](assets/enable-folder-hierarchy.png)

A funcionalidade [Habilitar hierarquia de pasta](../using/brand-portal-general-configuration.md) (quando habilitada) ajuda a diferenciar as pastas com os mesmos nomes compartilhados de hierarquias diferentes. Ao fazer logon, os usuários não administradores agora veem as pastas principais virtuais (e antecessoras) das pastas compartilhadas.
...
* Os usuários administradores podem usar o Navegador de caminho para navegar para qualquer diretório de pastas no Brand Portal.
* Usuários não administradores podem usar o Navegador de caminho para navegar somente até as pastas (e navegar de volta até as pastas principais) compartilhadas com eles.
  ...
  Por exemplo, `/content/dam/mac/<tenant-id>/folderA/folderB/folderC` é compartilhado com um usuário não administrador. O usuário pode pesquisar ativos na pasta C usando o Navegador de caminho. Esse usuário também pode navegar para a pasta B e a pasta A (já que são antecessoras da pasta C compartilhada com o usuário).
...
Os usuários cuja instância de criação do AEM está no modo híbrido do Dynamic Media podem visualizar e baixar as representações do Dynamic Media, além dos arquivos de vídeo originais.

Para habilitar a visualização e o download de representações de mídia dinâmica em contas de locatário específicas, os administradores especificam uma **Configuração de mídia dinâmica**. Esta etapa inclui o URL do serviço de vídeo e a ID de registro na configuração **Vídeo** do painel de ferramentas do administrador.


Os vídeos do Dynamic Media podem ser visualizados na:

* Página de detalhes do ativo
* Exibição de cartão do ativo
* Página de visualização do compartilhamento de link

A codificação de vídeo do Dynamic Media pode ser baixada a partir de:
...
### Publicar ativo agendado no Brand Portal

O fluxo de trabalho de publicação de ativos (e pastas) da instância de criação do AEM 6.4.2.0 para o Brand Portal pode ser agendado para uma data e hora posteriores.
...
As organizações podem personalizar o URL do portal com um prefixo alternativo no URL. Para obter um alias para o nome do locatário no URL do portal existente, as organizações devem entrar em contato com o Suporte ao cliente.

Somente o prefixo do URL do Brand Portal pode ser personalizado, não o URL inteiro.\
Por exemplo, uma organização com um domínio existente **geomettrix.brand-portal.adobe.com** pode criar **geomettrixinc.brand-portal.adobe.com** mediante solicitação.

No entanto, a instância de criação do AEM pode ser [configurada](https://experienceleague.adobe.com/pt-br/docs/experience-manager-65/content/assets/brandportal/configure-aem-assets-with-brand-portal) somente com o URL da ID do locatário e não com o URL do alias do locatário (alternativo).

As organizações podem atender às suas necessidades de marca personalizando o URL do portal, em vez usar o URL fornecido pela Adobe.

[![](assets/see-the-guide.png)](../using/brand-portal.md#tenantaliasforportalurl)

### Aprimoramentos na experiência de download
...
O AEM Brand Portal permite acesso de convidado ao portal. Um usuário convidado não precisa de credenciais para entrar no portal e pode acessar e baixar todas as pastas e coleções públicas. Os usuários convidados podem adicionar ativos à lightbox (coleção privada) e baixá-los. Eles também podem exibir a pesquisa de tag inteligente e pesquisar predicados definidos pelos administradores. A sessão de convidado não permite que os usuários criem coleções e pesquisas salvas ou as compartilhem ainda mais, acessem configurações de pasta e coleções e compartilhem ativos como links.
...
Uma sessão de convidado permanece ativa por duas horas. Portanto, o estado da lightbox também é preservado até duas horas após o horário de início da sessão. Após duas horas, a sessão de convidado tem que ser reiniciada, portanto o estado da lightbox é perdido.

### Downloads acelerados

Os usuários do Brand Portal podem aplicar downloads rápidos baseados no IBM® Aspera Connect para obter velocidades até 25 vezes mais rápidas e uma experiência de download contínua, independentemente da sua localização no mundo. Para baixar os ativos do Brand Portal ou do link compartilhado mais rapidamente, os usuários precisam selecionar a opção **Habilitar aceleração de download** na caixa de diálogo de download, desde que a aceleração de download esteja habilitada em suas organizações.

![](assets/donload-assets-dialog-2.png)

Para habilitar o download acelerado baseado no IBM® Aspera para a organização, os administradores selecionam a opção **Habilitar aceleração de download** (que está desabilitada por padrão) em [Configurações gerais](brand-portal-general-configuration.md#allow-download-acceleration) no painel de ferramentas administrativas.

Para obter os pré-requisitos e as etapas de solução de problemas para baixar os arquivos de ativos do Brand Portal e de links compartilhados mais rapidamente, consulte o [Guia para acelerar downloads do Brand Portal](../using/accelerated-download.md#main-pars-header).
...
O relatório registra os nomes de exibição, IDs de email, personas (administrador, visualizador, editor, convidado), grupos, último logon, status da atividade e contagem de logon de cada usuário a partir da implantação do Brand Portal 6.4.2 até o momento da geração do relatório. Os administradores podem exportar o relatório como .csv. Junto com outros relatórios, o relatório Logons de usuário permite que as organizações monitorem atentamente as interações do usuário com os recursos de marca aprovados, garantindo a conformidade com os escritórios de conformidade corporativa.
...
* Por padrão, todos os usuários podem baixar representações originais, já que o Acesso ao original está habilitado para todos.
...
* As permissões do usuário que está compartilhando ativos como um link se aplicam aos usuários que baixam ativos usando links compartilhados.

### Caminho de hierarquia de pastas em exibições de cartão e lista
...
As informações de hierarquia de pastas são particularmente úteis na diferenciação de pastas. Ou seja, pasta com nomes semelhantes a outras pastas compartilhadas de uma hierarquia de pastas diferente. Se os usuários não administradores não estiverem cientes da estrutura de pastas dos ativos compartilhados com eles, ativos/pastas com nomes semelhantes parecerão confusos.

* Os caminhos mostrados nos respectivos cartões são truncados para se ajustarem aos tamanhos dos cartões. No entanto, os usuários podem ver o caminho completo como uma dica de ferramenta passando o mouse sobre o caminho truncado.

![](assets/folder-hierarchy1-1.png)

A exibição de lista mostra um caminho de pasta de ativos em uma coluna para todos os usuários do Brand Portal.

![](assets/list-view-1.png)

### Opção de visão geral para exibir as propriedades do ativo

O Brand Portal fornece uma opção de Visão geral para usuários não administradores (Editores, Visualizadores, Usuários convidados) para visualizar Propriedades de ativos/pastas selecionados. A opção Visão geral está visível:

1. Na barra de ferramentas, na parte superior, selecione um ativo/pasta.
2. Na lista suspensa, selecione o Seletor de painéis.

Ao selecionar a opção Visão geral, enquanto um ativo/pasta é selecionado, os usuários podem ver o título, o caminho e a hora da criação do ativo. Já na página de detalhes do ativo, selecionar a opção Visão geral permite que os usuários vejam os metadados do ativo.
...
Seis novas configurações foram adicionadas para que os administradores habilitem ou desabilitem as seguintes funcionalidades em locatários específicos:
...
* Habilitar aceleração de download
...
O Brand Portal 6.4.1 é uma versão de atualização da plataforma. Ele apresenta vários novos recursos e aprimoramentos vitais, como navegação, pesquisa e melhorias de desempenho.
...
* Exibição de cartão aprimorada com suporte para cartões de tamanhos diferentes com base na configuração de exibição.
...
* Novo recurso para visualizar arquivos de áudio, enviados para o AEM, na página de detalhes do ativo.
* Novo recurso de Ativos relacionados fornecido em Propriedades de ativos. Os ativos relacionados publicados no Brand Portal a partir do AEM agora mantêm seus relacionamentos, com links para esses ativos relacionados disponíveis na página de propriedades.
* Foi introduzida uma nova configuração para restringir usuários não administradores de criar coleções públicas. As organizações podem trabalhar com a equipe de Suporte ao cliente para configurar esse recurso em contas específicas.

### Pesquisar aprimoramentos

* Foi introduzida a capacidade de retornar à mesma posição nos resultados da pesquisa, após navegar até um item de pesquisa, sem executar a consulta de pesquisa novamente.
* Uma nova contagem de resultados de pesquisa para exibir o número de resultados de pesquisa foi fornecida.
* O Filtro de pesquisa de tipo de arquivo aprimorado agora permite filtrar os resultados da pesquisa por tipos MIME específicos, como .jpg, .png e .psd, em vez de apenas categorias amplas, como Imagens, Documentos e Multimídia.
* Filtros de pesquisa aprimorados para coleções, com registros de data e hora precisos em vez da funcionalidade anterior do controle deslizante de tempo.
* Novos filtros de tipo de acesso foram introduzidos para pesquisar coleções públicas ou não públicas.

![](assets/accesstypefilter.png)

### Otimizações de download

* Um único arquivo grande é baixado diretamente, sem a criação de um arquivo zip, melhorando a velocidade e a produtividade.
* O limite de download por tamanho de arquivo para o recurso de compartilhamento de link é **1** GB.

* Os usuários agora podem optar por baixar apenas os arquivos personalizados e originais e impedir versões prontas para uso, enquanto baixam ativos do Brand Portal ou por meio do recurso de links compartilhados.
...
* Melhoria de até 40% na resposta de pesquisa de ativos.
...
**Introdução do relatório Compartilhamento de links**
Um novo relatório, para fornecer informações sobre links compartilhados, foi introduzido. O relatório Compartilhamento de links lista todos os URLs para os ativos compartilhados com usuários internos e externos. Ele gera relatórios para usuários em toda a organização no período especificado. Também informa quando o link foi compartilhado, por quem e quando expira.

![](assets/navigatereport.png)

**Ponto de entrada modificado para acessar o Relatório de uso**
O Relatório de uso agora está consolidado com outros relatórios e pode ser exibido no console Relatórios de ativos. Para acessar o console Relatórios de ativos, navegue até **Criar/gerenciar relatórios** no painel de ferramentas administrativas.

![](assets/accessassetreport.png)

**Uma experiência do usuário aprimorada para relatórios**
...
Cada um dos relatórios criados pode ser personalizado adicionando ou removendo colunas padrão. Além disso, colunas personalizadas podem ser adicionadas aos relatórios de Download, Expiração e Publicação para controlar o grau de granularidade.

### Ferramentas administrativas aprimoradas

Seletor de propriedades aprimorado nas ferramentas de administração para metadados, pesquisa e relatórios com recursos de autocompletar e navegação para simplificar a experiência do administrador.

### Outras melhorias

* Os ativos publicados no Brand Portal do AEM 6.3.2.1 e 6.4 agora podem ser disponibilizados publicamente marcando a caixa Publicar pasta pública na caixa de diálogo Replicação do AEM Assets Brand Portal.

![](assets/public-folder-publish.png)

* Os administradores são notificados por emails de solicitação de acesso, além das notificações na área de notificação do Brand Portal, caso alguém tenha solicitado acesso ao Brand Portal.
...
Os usuários agora podem solicitar acesso ao Brand Portal usando o novo recurso **precisa de acesso** disponível na tela de logon do Brand Portal.

![](assets/bplogin_request_access.png)

Se tiverem uma Adobe ID ou precisarem criar uma Adobe ID, os usuários poderão seguir o fluxo de trabalho apropriado para enviar uma solicitação. Os administradores de produtos do Brand Portal recebem essas solicitações em sua área de notificação e concedem acesso por meio do Adobe Admin Console.
...
O relatório de ativos baixados agora inclui a contagem de downloads de ativos por usuário dentro do intervalo de data e hora especificado. Os usuários podem baixar este relatório no formato .csv para compilar dados como a contagem total de downloads de um ativo licenciado.
...
Para obter mais informações, consulte a [notificação de manutenção do Brand Portal](https://experienceleague.adobe.com/pt-br/docs/experience-manager-brand-portal/using/introduction/brand-portal).

### Melhoria para ativos licenciados compartilhados usando o recurso de compartilhamento de links {#enhancement-for-licensed-assets-shared-using-the-link-share-feature}

Ao baixar ativos licenciados usando o recurso de compartilhamento de links, você será solicitado a concordar com o contrato de licença desses ativos.
...
O desempenho do seletor de usuários foi aprimorado para atender às necessidades de clientes com uma grande base de usuários.

### Alterações na identidade visual da Experience Cloud {#experience-cloud-branding-changes}

O Brand Portal agora está em conformidade com a nova identidade visual da Adobe Experience Cloud.
...
Para alinhar a experiência do usuário do Brand Portal com o AEM, a Adobe está migrando para a interface de usuário Coral 3. Essa alteração melhora a usabilidade geral, incluindo navegação e aparência.

#### Experiência de navegação aprimorada {#enhanced-navigational-experience}

* Acesso rápido às ferramentas administrativas através do novo logotipo da Adobe:
...
* Você também pode adicionar filtros para a pesquisa Omni para restringir ainda mais e acelerar a pesquisa.
...
* O novo recurso de aumento de pesquisa permite que você melhore a relevância da pesquisa para que ativos específicos apareçam no topo dos resultados da pesquisa.
...
Se imagens com tags inteligentes forem publicadas do AEM Assets para o Brand Portal, você poderá pesquisar essas imagens no Brand Portal usando os nomes das tags inteligentes como palavras-chave de pesquisa. Este recurso está disponível somente para arquivos.
...
Melhorias nos recursos de navegação, pesquisa e download melhoram bastante o desempenho do Brand Portal.

### Novo Digital Rights Management para ativos {#new-digital-rights-management-for-assets}
...
O Brand Portal 6.3.1 apresenta metadados adicionais, que estão em conformidade com o AEM Assets 6.3. Você pode usar o formulário Editor de esquemas para controlar os metadados que devem estar visíveis na página Propriedades do Assets. Os metadados dos ativos não são visíveis para usuários de compartilhamento de links externos, que só podem visualizar e baixar ativos usando o URL de compartilhamento de links.

![](assets/additionsinmetadata.png)

### Recursos adicionais para administradores {#additional-capabilities-for-administrators}

* Antes de finalizar as personalizações no papel de parede da tela de logon, os administradores podem visualizar as alterações.

![](assets/wallpaperpreview.png)

* Depois que um administrador adiciona novos usuários, eles são incluídos automaticamente no Brand Portal sem precisar aceitar nenhum convite.

### Novos recursos de publicação no AEM Assets 6.3 {#new-publishing-capabilities-in-aem-assets}

* Os administradores do AEM podem publicar o esquema de metadados do AEM Assets para o Brand Portal usando o AEM 6.3 SP 1-CFP 1 (6.3.1.1), disponibilizado no quarto trimestre de 2017.
...
* No AEM Assets, você pode publicar ativos e coleções que tenham tags, incluindo tags inteligentes. Você pode pesquisar esses ativos ou coleções usando essas tags como palavras-chave de pesquisa no Brand Portal.
